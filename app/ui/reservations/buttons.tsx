...
export function CreateReservation() {
  return (
    ...
    >
      <span className="hidden md:block">Create Reservation</span> <PlusIcon className="h-5 md:ml-4" />
    </Link>
  );
}
...
export function UpdateReservation({ id }: { id: string }) {
  return (
    <Link href="/dashboard/reservations" className="rounded-md border p-2 hover:bg-gray-100">
